...
export declare class Images extends APIResource {
     ...
     * @returns undefined
     */
    update(datasetId: string, documentId: string, params: UpdateImageReq, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    list(datasetId: string, params?: ListImageReq, options?: RequestOptions): Promise<ListImageData>;
}
