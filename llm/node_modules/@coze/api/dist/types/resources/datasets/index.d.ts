...
export declare class Datasets extends APIResource {
     ...
     */
    create(params: CreateDatasetReq, options?: RequestOptions): Promise<CreateDatasetData>;
    /**
     ...
     */
    list(params: ListDatasetReq, options?: RequestOptions): Promise<ListDatasetData>;
    /**
     ...
     */
    update(dataset_id: string, params: UpdateDatasetReq, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    delete(dataset_id: string, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    process(dataset_id: string, params: ProcessDatasetReq, options?: RequestOptions): Promise<DocumentProgressData>;
}
