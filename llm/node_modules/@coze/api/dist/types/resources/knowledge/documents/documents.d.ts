...
export declare class Documents extends APIResource {
     ...
     */
    list(params: ListDocumentReq, options?: RequestOptions): Promise<ListDocumentData>;
    /**
     ...
     */
    create(params: CreateDocumentReq, options?: RequestOptions): Promise<DocumentInfo[]>;
    /**
     ...
     * @returns void | 无返回
     */
    delete(params: DeleteDocumentReq, options?: RequestOptions): Promise<void>;
    /**
     ...
     * @returns void | 无返回
     */
    update(params: UpdateDocumentReq, options?: RequestOptions): Promise<void>;
}
