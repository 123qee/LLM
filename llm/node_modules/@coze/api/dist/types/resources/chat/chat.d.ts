...
export declare const handleAdditionalMessages: (additional_messages?: EnterMessage[]) => {
...
export declare class Chat extends APIResource {
     ...
     */
    create(params: CreateChatReq, options?: RequestOptions): Promise<CreateChatData>;
    /**
     * Call the Chat API to send messages to a published Coze agent. | 调用此接口发起一次对话，支持添加上下文
     * @docs en:https://www.coze.com/docs/developer_guides/chat_v3?_lang=en
     * @docs zh:https://www.coze.cn/docs/developer_guides/chat_v3?_lang=zh
     ...
     * @returns
     */
    createAndPoll(params: CreateChatReq, options?: RequestOptions): Promise<CreateChatPollData>;
    /**
     ...
     */
    stream(params: StreamChatReq, options?: RequestOptions): AsyncIterable<StreamChatData>;
    /**
     ...
     */
    retrieve(conversation_id: string, chat_id: string, options?: RequestOptions): Promise<CreateChatData>;
    /**
     ...
     */
    cancel(conversation_id: string, chat_id: string, options?: RequestOptions): Promise<CreateChatData>;
    /**
     ...
     */
    submitToolOutputs(params: SubmitToolOutputsReq, options?: RequestOptions): AsyncGenerator<StreamChatData, CreateChatData | undefined, unknown>;
}
...
export type StreamChatData = {
    event: ChatEventType.CONVERSATION_CHAT_CREATED | ChatEventType.CONVERSATION_CHAT_IN_PROGRESS | ChatEventType.CONVERSATION_CHAT_COMPLETED | ChatEventType.CONVERSATION_CHAT_FAILED | ChatEventType.CONVERSATION_CHAT_REQUIRES_ACTION;
    data: CreateChatData;
} | {
    event: ChatEventType.CONVERSATION_MESSAGE_DELTA | ChatEventType.CONVERSATION_MESSAGE_COMPLETED | ChatEventType.CONVERSATION_AUDIO_DELTA;
    data: ChatV3Message;
} | {
...
export type MessageType = 'question' | 'answer' | 'function_call' | 'tool_output' | 'tool_response' | 'follow_up' | 'verbose';
