...
export declare class Messages extends APIResource {
     ...
     */
    create(conversation_id: string, params: CreateMessageReq, options?: RequestOptions): Promise<ChatV3Message>;
    /**
     ...
     */
    update(conversation_id: string, message_id: string, params: UpdateMessageReq, options?: RequestOptions): Promise<ChatV3Message>;
    /**
     ...
     */
    retrieve(conversation_id: string, message_id: string, options?: RequestOptions): Promise<ChatV3Message>;
    /**
     ...
     */
    list(conversation_id: string, params?: ListMessageReq, options?: RequestOptions): Promise<ListMessageData>;
    /**
     ...
     */
    delete(conversation_id: string, message_id: string, options?: RequestOptions): Promise<ChatV3Message>;
}
