...
export declare class Bots extends APIResource {
    /**
     ...
     */
    create(params: CreateBotReq, options?: RequestOptions): Promise<CreateBotData>;
    /**
     ...
     */
    update(params: UpdateBotReq, options?: RequestOptions): Promise<undefined>;
    /**
     ...
     */
    list(params: ListBotReq, options?: RequestOptions): Promise<ListBotData>;
    /**
     ...
     * @returns Undefined | 无返回值
     */
    publish(params: PublishBotReq, options?: RequestOptions): Promise<undefined>;
    /**
     ...
     */
    retrieve(params: RetrieveBotReq, options?: RequestOptions): Promise<BotInfo>;
}
