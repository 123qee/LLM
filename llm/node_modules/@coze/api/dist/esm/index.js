...
class CozeAPI extends APIClient {
   ...
   * @deprecated
   */ this.knowledge = new Knowledge(this), this.datasets = new Datasets(this), this.workflows = new Workflows(this), this.workspaces = new WorkSpaces(this), this.audio = new Audio(this), this.templates = new Templates(this);
    }
}
export { APIConnectionError, APIError, APIUserAbortError, Audio, AuthenticationError, BadRequestError, Bots, COZE_CN_BASE_URL, COZE_COM_BASE_URL, Chat, chat_ChatEventType as ChatEventType, chat_ChatStatus as ChatStatus, Conversations, CozeAPI, CozeError, Datasets, documents_Documents as Documents, Files, GatewayError, Images, InternalServerError, JSONParseError, Knowledge, MAX_POLL_INTERVAL, messages_Messages as Messages, NotFoundError, Documents as OldDocuments, auth_PKCEAuthErrorType as PKCEAuthErrorType, POLL_INTERVAL, PermissionDeniedError, RateLimitError, chat_RoleType as RoleType, Rooms, Runs, templates_TemplateEntityType as TemplateEntityType, Templates, TimeoutError, Voices, WorkSpaces, WorkflowChat, WorkflowEvent, runs_WorkflowEventType as WorkflowEventType, Workflows, _getJWTToken, castToError, fetchAPI, getDeviceCode, getDeviceToken, getJWTToken, getPKCEAuthenticationUrl, getPKCEOAuthToken, getWebAuthenticationUrl, getWebOAuthToken, handleAdditionalMessages, refreshOAuthToken };
